  ...
  Plugin.prototype = {
    init: function(){
      var _this    = this,
          ...
          tooltip = jQuery('<div/>', {class: 'tooltip', text: 'Min ' + this.options.minCarac + ' chars'})
    ...
    check: function(value){
      ...
      if(value.length >= this.options.minCarac){
        chars = 1;
      }else{
        chars = -1;
      }
    ...
    addStatus: function(percentage){
      var status = '',
          text = 'Min ' + this.options.minCarac + ' chars',
    ...
    togglePassword: function(){
      var buttonShow = jQuery('<span/>', {class: 'showPassword', html: '<img src="'+ this.options.logo_eye +'" />'}),
